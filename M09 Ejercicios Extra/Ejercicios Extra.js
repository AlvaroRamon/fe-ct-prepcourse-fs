...
function asAmirror(frase) {
   ...
   for (var i = 0; i < palabras.length; i++) {
      var palabraInvertidas = palabras[i].split("").reverse().join("");
      palabras[i] = palabraInvertidas;
   }
